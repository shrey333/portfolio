export const EXPERIENCE = [
  {
    ...
    companyDescription: [
      ...
      "Automated journal crawling with Python-based scripts, integrating Crossref API for DOI registration and configuring domain setups in AWS Route 53, reducing average registration time from 2 hours to under 20 minutes",
      ...
      "Built an internal page builder using a Python-based data model to streamline content creation and launched Neliti's ad platform, integrating with frontend technologies like AlpineJS for a seamless user experience",
    ],
  ...
  },
  {
    ...
    companyDescription: [
      "Collaborated with cross-functional team to automate accounting data entry using Node.js, React, DynamoDB, and GraphQL, achieving high-throughput processing (10,000+ rows in less than 2 minutes) and reducing manual effort",
