...
export default function NavBar() {
  ...
  return (
    <>
      <nav className="sticky-nav !top-2 sm:!top-4 mt-2 sm:mt-4 rounded-xl sm:rounded-2xl flex justify-between items-center content-center max-w-4xl w-[calc(100%-1rem)] sm:w-[calc(100%-2rem)] p-2 px-4 mx-auto bg-white/50 dark:bg-gray-900/50 backdrop-blur-xl border border-gray-200 dark:border-gray-800">
        <motion.div
